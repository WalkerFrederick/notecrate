...
function BigReview() {
  return (
    <div className="BigReview">
        <div className="BigReview-container">
            <Logo/>
            <div  className="content">
            <div className="stars">
                <Fade direction={"up"}><Star active="true"/></Fade>
                <Fade delay={100} direction={"up"}><Star active="true"/></Fade>
                <Fade delay={200} direction={"up"}><Star active="true"/></Fade>
                <Fade delay={300} direction={"up"}><Star active="true"/></Fade>
                <Fade delay={400} direction={"up"}><Star active="true"/></Fade>
            </div>
            <p>This box is absolutely fantastic - suprising amount of variety in the products they sent out and great paper quality in the notebooks. Can't Wait For Next Month.</p>
            <span>- Jess Meyers</span>
            </div>
        </div>
    </div>
  );
...
export const Star = (props) => {
    return (<svg className={props.active ? 'active': ''} xmlns="http://www.w3.org/2000/svg" width="58" height="55" viewBox="0 0 58 55" fill="#fff">
